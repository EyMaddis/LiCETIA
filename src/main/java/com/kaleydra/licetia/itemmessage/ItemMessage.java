package com.kaleydra.licetia.itemmessage;
 ...
 * 
 * 
 * Just create an instance and use instance.sendMessage()
 * @author desht
 * @see http://forums.bukkit.org/threads/itemmessage-use-item-metadata-to-create-popup-messages.167979/
 */
